...
- [Glossary.md](Docs/Glossary.md) — v0.10 (new *`satisfies`* entry per ADR/0009 — first relationship-type entry; first occupant of the bundle's `relationship/` directory)
