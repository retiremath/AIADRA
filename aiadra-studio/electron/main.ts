...
function registerIpc(): void {
  ...
  // the session.
  // Codex27 B1: the allowlist + param rules are EXTRACTED PURE
  // (./authoringParamRules) so the renderer op-builders are driven
  // through the exact boundary in tests — the desktop-walk lesson as a
  // regression, not a memory.
